...
namespace RSSNewsReader
{
    static class Program
    {
        ...
        /// </summary>
        private const string EVENT_LOG_SOURCE = "RSSNewsReader"; // <======= *** CHANGE ME!!!!******
        /// <summary>
        ...
        /// <summary>
        /// Logs the given error to the System log if running as installed. Requires a registered event handler.
        /// </summary>
        /// <param name="e"></param>
